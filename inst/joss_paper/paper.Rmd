...
```{r icesat2-diagram, fig.pos='h', out.width = "100%", out.height = "40%", fig.align = 'center', fig.cap = "IceSat2R Workflow Diagram", fig.alt="The Diagram of the IceSat2R package functionality"}
